...
public class B_Concat {
    public static void main(String[] args) {
        ...
        // Combining flux 1 with 2 it will maintain order so after flux1, flux 2 will emit even though flux 2 is ready before 1
//        Flux<String> flux = flux1.concatWith(flux2);
//        flux.subscribe(Util.subscriber("Amit -->"));

//      Combining flux 1,2 and 3 using factory method due to error in flux3 won't see flux2
