...
/*Limit rate limits the rate at which the publisher publishes the data,
The first item tells the number of items pusher should publish first
The 2nd item tells what percentage of data when already sent after which subscriber will request for next set.
(100,65) means publisher will send 100 items and when it reaches 65% of 100, subscriber  will request for next set
default is 75%. 
